...
const SingleProject = ({ name, year, align, image, details }) => {
  //link
  return (
    <motion.div
    ...
    >
      <div>
        <h2
          className={`md:text-3xl sm:text-2xl text-orange sm:text-center ${
        ...
        <p className="lg:text-xl md:text-lg text-md mt-4">{details}</p>
